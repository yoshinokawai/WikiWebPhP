...
<script>
    ...
    function filterCategory(cat, btn) {
        ...
        document.querySelectorAll('.category-btn').forEach(function(b) {
            b.className = "category-btn flex h-11 shrink-0 items-center justify-center rounded-xl bg-slate-50 dark:bg-slate-800/50 px-5 text-slate-700 dark:text-slate-200 border border-slate-200/50 dark:border-slate-700/50 text-xs font-bold transition-all hover:bg-primary/5";
        });

        // Set active button style
        btn.className = "category-btn flex h-11 shrink-0 items-center justify-center rounded-xl bg-primary px-5 text-white shadow-lg shadow-primary/20 text-xs font-bold transition-all hover:brightness-110";
